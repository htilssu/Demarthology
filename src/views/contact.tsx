    ...
    <div className="bg-white min-h-screen relative">
      ...
      <div className="container mx-auto px-4 py-12 grid md:grid-cols-2 gap-8 relative z-10">
        ...
        <MotionWrapper animation="slideLeft" delay={0.2}>
          <div className="w-full h-[400px] motion-card">
            <iframe
        ...
        <MotionWrapper animation="slideRight" delay={0.4}>
          <div className="bg-gray-50 p-6 rounded-lg shadow-md motion-card">
            ...
            <form className="space-y-4">
              ...
              <MotionWrapper animation="slideUp" delay={1.0}>
                <button
                  type="submit"
                  className="bg-teal-700 text-white px-6 py-3 rounded-lg hover:bg-teal-800 transition motion-button"
                >
                  Gửi ngay
                </button>
              </MotionWrapper>
